...
export const levels: LevelData[] = [
  ...
  },
  {
    ...
    subtitle: 'A market district rebuilt by every minute it lost.',
    width: 2740,
    height: 720,
    spawn: { x: 95, y: 600 },
    ...
    background: 'streets',
    startLines: [
      'The market did not close. It split. Every stall sells a different minute of the same afternoon.',
      'Past rooftops, Present canvas, Future wreckage. The way through is not a line. It is a memory with exits.',
    ],
    platforms: [
      { id: 'market-entry-street', x: 430, y: 690, width: 860, height: 60 },
      { id: 'market-center-street', x: 1425, y: 690, width: 610, height: 60 },
    ...
    doors: [
      {
        id: 'market-memory-lock',
        x: 1730,
        y: 610,
        width: 54,
        height: 102,
        requiresFlags: ['market_key'],
        states: {
          past: { solid: true, visible: true, color: 0x75614d },
          present: { solid: true, visible: true, color: 0x32434f },
          future: { solid: false, visible: true, color: 0x57333b, alpha: 0.28 },
        },
      },
    ],
    plates: [],
    ...
    storyZones: [
      {
        ...
        height: 140,
        once: true,
        lines: ['The stalls stack on each other like excuses. Past goes high. Future goes low. Present asks for a price.'],
      },
      {
        ...
        height: 140,
        once: true,
        lines: ['The lock remembers a key bought in the Present, even when Elias opens it in another hour.'],
      },
    ],
    memoryFragments: [
      {
        id: 'market-photo-strip',
        title: 'Memory Fragment: Photo Strip',
        x: 1880,
        y: 480,
        lines: ['Four tiny frames. Elias, the girl, a paper crown, then only the empty booth. The last photo is still developing.'],
      },
    ],
