...
export const levels: LevelData[] = [
  {
    ...
    height: 720,
    spawn: { x: 90, y: 600 },
    objective: 'Use Past for the bridge, then Future to pass the gate.',
    nextLevelId: 'level-1',
    startTimeline: 'present',
    background: 'reactor',
    startLines: [
      'Elias wakes under a dead clock. The Core is in his chest, ticking in three directions.',
      'The city outside is silent. Press Q to cycle time, or 1, 2, 3 to choose Past, Present, Future.',
    ],
    platforms: [
    ...
    storyZones: [
      {
        ...
        height: 140,
        once: true,
        lines: ['The bridge is broken now, but it remembers being whole. Shift to Past before you cross.'],
      },
      {
        id: 'future-hint',
        x: 1420,
        ...
        height: 140,
        once: true,
        lines: ['The gate blocks the present. In the ruined future, it has already collapsed.'],
      },
    ],
  ...
  },
  {
    ...
    height: 720,
    spawn: { x: 90, y: 600 },
    objective: 'Record an echo on the plate, then cross while it holds the door.',
    nextLevelId: 'level-2',
    startTimeline: 'present',
    background: 'streets',
    startLines: [
    ...
    storyZones: [
      {
        ...
        height: 140,
        once: true,
        lines: ['Stand on the plate, press G to record, wait a breath, then press G again. Your echo will replay it.'],
      },
      {
        id: 'keeper-trace',
        x: 1560,
  ...
  },
  {
    ...
    height: 720,
    spawn: { x: 95, y: 600 },
    objective: 'Use the switch, then shift timelines to rebuild the route.',
    nextLevelId: 'level-3',
    startTimeline: 'present',
    ...
    storyZones: [
      ...
      },
      {
        ...
        height: 140,
        once: true,
        lines: ['Press E at a switch. If a route closes behind you, an echo can repeat the same choice.'],
      },
    ],
  ...
  },
  {
    ...
    height: 720,
    spawn: { x: 95, y: 600 },
    objective: 'Cross by swapping between Past, Present, and Future platforms.',
    nextLevelId: 'boss',
    startTimeline: 'present',
    background: 'station',
    startLines: [
    ...
    storyZones: [
      {
        ...
        height: 140,
        once: true,
        lines: ['The switch only exists in the ruined future. The Keeper speaks: "If time moves, it takes everything."'],
      },
    ],
  ...
  },
  {
    ...
    height: 720,
    spawn: { x: 95, y: 600 },
    objective: 'Echo the Past plate, trigger the Present switch, then the Future switch.',
    startTimeline: 'present',
    background: 'core',
    startLines: [
      'At the center of the city, every broken timeline points to one man.',
      'The Keeper raises Elias\'s hand with Elias\'s face and says, "I saved us from goodbye." Three anchors hold the hour shut.',
    ],
    platforms: [
    ...
    storyZones: [
      {
        ...
        height: 140,
        once: true,
        lines: ['First anchor: shift to Past, record yourself standing on this plate, then let the echo hold it.'],
      },
      {
        id: 'boss-present',
        x: 1220,
        ...
        height: 170,
        once: true,
        lines: ['Second anchor: the upper switch answers only in Present. Press E beside it.'],
      },
      {
        id: 'boss-future',
        x: 1720,
        ...
        height: 140,
        once: true,
        lines: ['Third anchor: the last switch survives only in Ruined Future. Cross the red span and press E.'],
      },
      {
        id: 'keeper-reveal',
        x: 2020,
